...
const Name tau_syn_ex_decay( "tau_syn_ex_decay" );
const Name tau_syn_ex_rise( "tau_syn_ex_rise" );
const Name tau_syn_in( "tau_syn_in" );
const Name tau_syn_in_decay( "tau_syn_in_decay" );
const Name tau_syn_in_rise( "tau_syn_in_rise" );
