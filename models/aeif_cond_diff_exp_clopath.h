...
#ifndef AEIF_COND_DIFF_EXP_CLOPATH_H
#define AEIF_COND_DIFF_EXP_CLOPATH_H
 ...
 */
extern "C" int aeif_cond_diff_exp_clopath_dynamics( double, const double*, double*, void* );
 ...
 * @param void* Pointer to model neuron instance.
 */
extern "C" int aeif_cond_diff_exp_clopath_dynamics_DT0( double, const double*, double*, void* );
...
aeif_cond_diff_exp_clopath is the adaptive exponential integrate and fire neuron according
...
-------------------------------------------------------------------------------
 ...
 tau_syn_ex_decay   ms      Decay time of excitatory synaptic conductance (difference of exp functions)
 tau_syn_ex_rise    ms      Rise time of excitatory synaptic conductance (difference of exp functions)
 E_in               mV      Inhibitory reversal potential
 tau_syn_in_decay   ms      Decay time of the inhibitory synaptic conductance (difference of exp functions)
 tau_syn_in_rise    ms      Rise time of the inhibitory synaptic conductance (difference of exp functions)
=================== ======= ===========================================================
...
class aeif_cond_diff_exp_clopath : public ClopathArchivingNode
{

public:
  aeif_cond_diff_exp_clopath();
  aeif_cond_diff_exp_clopath( const aeif_cond_diff_exp_clopath& );
  ~aeif_cond_diff_exp_clopath();
...
private:
  ...
  friend int aeif_cond_diff_exp_clopath_dynamics( double, const double*, double*, void* );

  // The next two classes need to be friends to access the State_ class/member
  friend class RecordablesMap< aeif_cond_diff_exp_clopath >;
  friend class UniversalDataLogger< aeif_cond_diff_exp_clopath >;
...
private:
  ...
  struct Parameters_
  {
    ...
    double tau_syn_ex_decay;        //!< Excitatory synaptic decay time
    double tau_syn_ex_rise;         //!< Excitatory synaptic rise time
    double tau_syn_in_decay;        //!< Excitatory synaptic decay time
    double tau_syn_in_rise;         //!< Excitatory synaptic rise time
...
public:
  ...
  struct Buffers_
  {
    Buffers_( aeif_cond_diff_exp_clopath& );                  //!<Sets buffer pointers to 0
    Buffers_( const Buffers_&, aeif_cond_diff_exp_clopath& ); //!<Sets buffer pointers to 0

    //! Logger for all analog data
    UniversalDataLogger< aeif_cond_diff_exp_clopath > logger_;
  ...
  static RecordablesMap< aeif_cond_diff_exp_clopath > recordablesMap_;
};

inline port
aeif_cond_diff_exp_clopath::send_test_event( Node& target, rport receptor_type, synindex, bool )
{
  SpikeEvent e;
  e.set_sender( *this );
...
inline port
aeif_cond_diff_exp_clopath::handles_test_event( SpikeEvent&, rport receptor_type )
{
  if ( receptor_type != 0 )
  {
...
inline port
aeif_cond_diff_exp_clopath::handles_test_event( CurrentEvent&, rport receptor_type )
{
  if ( receptor_type != 0 )
  {
    throw UnknownReceptorType( receptor_type, get_name() );
...
inline port
aeif_cond_diff_exp_clopath::handles_test_event( DataLoggingRequest& dlr, rport receptor_type )
{
  if ( receptor_type != 0 )
  {
    throw UnknownReceptorType( receptor_type, get_name() );
...
inline void
aeif_cond_diff_exp_clopath::get_status( DictionaryDatum& d ) const
{
  P_.get( d );
  S_.get( d );
...
inline void
aeif_cond_diff_exp_clopath::set_status( const DictionaryDatum& d )
{
...
#endif // HAVE_GSL
#endif // AEIF_COND_DIFF_EXP_CLOPATH_H
